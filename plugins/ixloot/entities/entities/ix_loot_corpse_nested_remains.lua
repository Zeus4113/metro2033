...
ENT.displayName = "Nested Remains"
...
if ( SERVER ) then
    function ENT:Initialize()
        self:SetModel("models/metro/props/deadbodies/redux_corpse05.mdl")
    ...
    function ENT:SpawnFunction(client, trace)
        ...
        local entity = ents.Create("ix_loot_corpse_nested_remains")
