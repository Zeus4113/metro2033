...
ENT.Type             = "anim"
ENT.PrintName        = "Painted Storage Box"
ENT.Author            = "Riggs"
...
ENT.displayName = "Painted Storage Box"
ENT.searchText = "Searching... "
ENT.description = [[
A small metal box with faded paint and worn edges from years of handling. 

Containers like this are commonly used to keep miscellaneous belongings together.
]]
...
if ( SERVER ) then
    ...
    function ENT:SpawnFunction(client, trace)
        ...
        local entity = ents.Create("ix_loot_general_storage_box")
