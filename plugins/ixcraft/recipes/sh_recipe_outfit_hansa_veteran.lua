RECIPE.name = "Craft Hansa Veteran Uniform"
RECIPE.description = "Reinforce a Hansa guard uniform with ballistic plating for seasoned veterans."
...
RECIPE:PostHook("OnCanSee", function(recipeTable, client)
	if not client or not client:GetCharacter() then return false end
	return client:GetCharacter():GetFaction() == FACTION_HANSA and client:HasClassWhitelist(CLASS_HANSA_VETERAN)
end)
