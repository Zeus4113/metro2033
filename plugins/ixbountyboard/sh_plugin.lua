...
PLUGIN.bountyPool = {
    ...
    { id = "col_filter",         type = "collect", target = "filter",                 count = 3, reward = 4, name = "Filter Drive",        desc = "Deliver %d gasmask filters." },
    ...
    { id = "col_purified_water", type = "collect", target = "purified_water",         count = 3, reward = 3, name = "Water Collection",    desc = "Deliver %d bottles of purified water." },
